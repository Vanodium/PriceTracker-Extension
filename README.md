This is my chrome extension, which interracts with [API](https://github.com/Vanodium/PriceTracker-API) to add/remove/display price trackers, which will notify you in case it changes
